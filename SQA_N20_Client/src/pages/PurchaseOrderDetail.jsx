...
const PurchaseOrderDetail = () => {
    ...
    const purchaseOrderId = location.pathname.split("/")[2];
    ...
    const handleDelete = async () => {
        ...
        setLoading(true);
        const res = await productServices.deleteProduct(purchaseOrderId);
        setLoading(false);
        console.log("Res", res);
        if (res.data.status === "Failed") {
            ...
            setModalMessage("Xoá sản phẩm thành công!");
    ...
    useEffect(() => {
        const getProductDetail = async () => {
            const res = await productServices.getProductDetail(purchaseOrderId);
                ...
                <div style={{ borderRadius: 6, overflow: "hidden", border: "1px solid #ccc" }}>
                    ...
                    <ButtonGroup>
                        ...
                        <Button
                            ...
                            size='large'
                            type='primary'
                            onClick={() => navigate(`/purchase-order/${purchaseOrderId}/update`)}
                        >
                            Sửa thông tin
                        </Button>
                        <Button
